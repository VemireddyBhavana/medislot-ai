                ...
                <AnimatePresence mode="wait">
                  {!triageResult ? (
                    ...
                    >
                      ...
                      <div>
                        <label className="block text-[11px] font-bold text-slate-700 dark:text-slate-300 mb-1.5">Preferred Date</label>
                          ...
                          {[
                            ...
                            return (
                              <button
                                key={opt.label}
                                type="button"
                                onClick={() => setPreferredDate(dateVal)}
                                className={`py-2 px-2 text-[11px] rounded-lg font-bold transition-all border ${
